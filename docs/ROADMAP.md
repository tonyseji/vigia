...
| 4 | **Frontend** — la app con el diseño aprobado, levantable en local | Pendiente |
| 5 | **Refresco automático** — `pg_cron` apuntando a la función nueva | Pendiente |
...
| B2 | Precio manual para tiendas bloqueadas | Ya existe en la app vieja (botón ✎). Imprescindible mientras Kave Home y Maisons du Monde bloqueen. Ver `docs/TIENDAS.md`. |
